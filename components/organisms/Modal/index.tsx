...
export default function Modal({ show, title, children, onClosed, onSave, isLoading, onEdit, saveTitle }: ModalProps) {
    ...
    return (
        <div className={`${show ? 'flex' : 'hidden'} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-dark-50 dark:bg-light-50`} id="modal">
